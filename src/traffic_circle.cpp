...
void youhuandao_deal() // ????????
{
    ...
    if (right_huan_num == 1)
    {
        ...
        // }
        right_buxian(left_line[15] + 60, 10, 150, 68);
        //  sousuojieshuhang=15;
    }
    ...
    else if (right_huan_num == 4)
    {
        ...
        for (int y = 68; y > 5; y--) // x???59??56  num???0??4
        {
            for (unsigned int x = 160; x <= 184; x++) // ?技???????????
            {
                if (image_use[y][x - 1] == 255 && image_use[y][x] == 255 && image_use[y][x + 1] == 0 && image_use[y][x + 2] == 0) // ?????????????
                {
            ...
            for (unsigned int x = 160; x >= 1; x--) // ?技???????????
            {
                if (image_use[y][x - 1] == 0 && image_use[y][x] == 0 && image_use[y][x + 1] == 255 && image_use[y][x + 2] == 255) // ?????????????
                {
                    Left_Line_New[y] = x + 1;
                    break;
                }
    ...
    else if (right_huan_num == 5)
    {
        ...
        for (y = 68; y > 5; y--) // x???59??56  num???0??4
        {
            for (unsigned int x = 160; x <= 184; x++) // ?技???????????
            {
                if (image_use[y][x - 1] == 255 && image_use[y][x] == 255 && image_use[y][x + 1] == 0 && image_use[y][x + 2] == 0) // ?????????????
    ...
    else if (right_huan_num == 7)
    {
        ...
        {
            find_leftdown_point(65, 25, 1); // 1?????
            right_buxian2(150, sousuojieshuhang, left_turn_down[1] + 15, left_turn_down[0]);
            ////????????
        }
    }
    ...
    else if (right_huan_num == 8)
    {
        ...
        right_buxian(left_line[15] + 80, 10, 150, 68);
        ////???????
    }
}

void zuohuandao_deal() // ????????
{
    int y = 0;
    ...
    if (left_huan_num == 1)
    {
        ...
        // else
        {
            left_buxian(right_line[15] - 65, 10, 25, 68);
            //  flag_find_huan_leftmiddle_point=0;
        }
    }
    ...
    else if (left_huan_num == 4)
    {
        ...
        for (y = 68; y > 10; y--) // x???59??56  num???0??4
        {
            for (int x = 40; x <= 184; x++) // ?技???????????
            {
                if (image_use[y][x - 1] == 255 && image_use[y][x] == 255 && image_use[y][x + 1] == 0 && image_use[y][x + 2] == 0) // ?????????????
                {
    ...
    else if (left_huan_num == 7)
    {
        ...
        {
            find_rightdown_point(65, 25, 1);                                            // 1?????
...
void youhuandao() // ?????
{
    ...
    if (!youhuihuan_flag && !left_huan_num && !three_cross && !poer_flag && !star_lineflag && !por_cnt) //
    {
        ...
        {
            find_rightmiddle_point(40, 20);
            guaidian = right_turn_middle[0];
            if (huan2_flag == 0)
                right_huan_num = 0;
            if (right_huan_num == 2 && r_start >= 58 && guaidian >= 22) // l_start>= 50&&r_start<=35
            {
                cnt2++; // ????3???忪?
            }
            else
        ...
        else if (right_huan_num == 3 && right_turn_up[0] > 30) //>35)//right_turn_up[0]////right_huan_num==3&&r_start<=40
        {
            guaidian = 0;
            right_huan_num = 5; // ??????????
        }
        ...
        else if (right_huan_num == 6 && Left_Add_num > 8 && left_turn_down[0] > 20 && left_turn_down[0] != 69) //&&left_turn_down[0]<50
        {
            right_huan_num = 7;
        }
        else if (right_huan_num == 7 && sousuojieshuhang <= 15 && zuodiuxianshu < 20 && Left_Add_num < 8 && (huandao_7 >= 10 || (k_left < -0.5 && k_left > -1.5))) //&&zuodiuxianshu<5
        {
...
void zuohuandao() // zuo????
{
    ...
    if (!lefthuihuan_flag && !right_huan_num && !three_cross && !poer_flag && !star_lineflag && !por_cnt) //
    {
        ...
        else if (left_huan_num == 1 && r_start >= 55 && l_start <= 40 && l_start >= 25) //&&(ad_guiyi[2]>100||ad_guiyi[0]>100)
        {
            time1 = 0;
            huan2_flag = 1;
        ...
        {
            find_leftmiddle_point(40, 20);
            guaidian = left_turn_middle[0];
            if (huan2_flag == 0)
                left_huan_num = 0;
            if (left_huan_num == 2 && l_start >= 67 && guaidian > 22) // 35//
            {
                cnt2++; // ????3???忪?
                if (cnt2 >= 2 && gou_Guo2 == 0)
                {
        ...
        else if (left_huan_num == 3 && (left_turn_up[0] > 32)) //>30)//right_turn_up[0]////right_huan_num==3&&r_start<=40
        {
            left_huan_num = 5; // ??????????
        }
