...
ENCODER::ENCODER(int pwmNum, int gpioNum) : base_addr(PWM_BASE_ADDR + pwmNum * PWM_OFFSET), directionGPIO(gpioNum, "in")
{

    control_buffer = map_register(base_addr + CONTROL_REG_OFFSET, PAGE_SIZE); // 控制寄存器映射
