...
typedef struct Data_Path
{
    ...
    int SideCoordinate_Eight_Warped[10000][4]={0};          // 逆透视左右边线坐标(八邻域)   
    int SideCoordinate_Warped[10000][4]={0};                // 逆透视左右边线坐标(中线寻线法)    
    int NumSearch[2] = {0};                        // 左右八邻域寻线坐标数量
    int TrackCoordinate[10000][2] = {0};           // 路径线坐标
    int TrackCoordinate_Warped[10000][2] = {0};             // 逆透视路径线坐标
